...
const ProductDetails = () => {
  ...
  return (
    <div className="min-h-screen py-12 px-6 sm:px-12 lg:px-24">
      <Helmet>
        {" "}
        <title>NextGen Cars | Product-Details</title>
      </Helmet>
        ...
        <div className="p-8 sm:p-16 bg-gradient-to-r from-blue-50 via-white to-blue-50 rounded-b-xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 text-center">
            <div className="p-6 bg-gray-100 rounded-lg shadow-md">
              <h3 className="text-2xl font-title font-bold text-gray-800">
                Price
              </h3>
              <p className="font-body text-green-600 font-semibold mt-2">
                ₺ {price}
              </p>
            </div>
            <div className="p-6 bg-gray-100 rounded-lg shadow-md">
              ...
              <p className="font-body text-gray-800 font-semibold mt-2">
                {quantity}
              </p>
            </div>
            <div className="p-6 bg-gray-100 rounded-lg shadow-md">
