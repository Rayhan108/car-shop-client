...
const Navbar = () => {
  ...
  return (
    <nav className={cn(" fixed top-0 w-full z-50 shadow-md")}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden font-body lg:flex lg:items-center lg:space-x-6">
            ...
            <Link to="/products" className="text-sm font-medium  hover:text-gray-900">
              All Products
            </Link>
            <Link to="/about" className="text-sm font-medium  hover:text-gray-900">
              About
            </Link>
